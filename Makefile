...
TESTBENCH   = test/sensor_chain_mpl_tb.sv
SOURCES     = verilog/sensor_result_mux.sv verilog/time.sv verilog/i2c_master.sv verilog/sensor_i2c_mux.sv verilog/mpl3115_ctrl.sv
SYNTH_FILES = 
MODULE_TOP  = 
